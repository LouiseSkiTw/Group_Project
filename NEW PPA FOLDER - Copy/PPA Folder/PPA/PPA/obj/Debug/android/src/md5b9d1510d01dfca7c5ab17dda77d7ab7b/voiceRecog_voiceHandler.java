...
/** @hide */
	...
	public voiceRecog_voiceHandler ()
	{
		super ();
	...
	public voiceRecog_voiceHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == voiceRecog_voiceHandler.class)
	...
	public voiceRecog_voiceHandler (android.os.Looper p0)
	{
		super (p0);
		if (getClass () == voiceRecog_voiceHandler.class)
	...
	public voiceRecog_voiceHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == voiceRecog_voiceHandler.class)
	...
	public voiceRecog_voiceHandler (md5b9d1510d01dfca7c5ab17dda77d7ab7b.voiceRecog p0)
	{
		super ();
		if (getClass () == voiceRecog_voiceHandler.class)
